...
export default function WarriorPoseEstimation() {
  ...
  const isWarriorPose = (
    ...
    const leftLegStraight = calculateAngle(leftHip, leftKnee, leftAnkle) > 160;
    const rightLegBent = calculateAngle(rightHip, rightKnee, rightAnkle) < 90;
    const torsoStraight = calculateAngle(leftShoulder, leftHip, leftKnee) > 160;
    const armsStraight = calculateAngle(leftShoulder, rightShoulder, leftHip) > 160;
    return leftLegStraight && rightLegBent && torsoStraight && armsStraight;
  };
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center p-6">
      <h1 className="text-3xl font-bold flex items-center gap-2">
        <span className="text-red-500">AI</span> Warrior Pose Counter
      </h1>
